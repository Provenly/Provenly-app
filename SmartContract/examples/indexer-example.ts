/**
 * Example Indexer for Provenly Contract Events
 * 
 * This TypeScript example demonstrates how to efficiently query and index
 * events from the Provenly Soroban contract using indexed fields.
 * 
 * Usage:
...
// Usage Example
async function main() {
  const indexer = new ProvenlyIndexer(CONTRACT_ID, RPC_URL);

  console.log('=== Provenly Event Indexing Example ===\n');
...
export default ProvenlyIndexer;
