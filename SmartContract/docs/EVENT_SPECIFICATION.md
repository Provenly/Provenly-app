...
This document defines the complete event specification for the Provenly Soroban smart contract. All events are designed with **indexed fields** to enable efficient off-chain querying, subgraph integration, and indexer compatibility.
