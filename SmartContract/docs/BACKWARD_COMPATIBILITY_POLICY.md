# Provenly Smart Contract - Backward Compatibility Policy

This document defines the official **Backward Compatibility Policy** for the Provenly Soroban smart contracts. It sets the engineering standards, versioning semantics, and migration requirements for evolving contract events and persistent storage schemas. 
...
The Provenly platform relies heavily on both **on-chain contract state** (for core consensus and security) and **off-chain indexed state** (subgraphs and custom indexers for user interfaces and analytics). 
...
- All event declarations, topic allocations, and emissions in [events.rs](file:///c:/Users/USER/Desktop/Projects/Provenly/contracts/earn-quest/src/events.rs).
- All `DataKey` structures, storage layouts, and schema models defined in [storage.rs](file:///c:/Users/USER/Desktop/Projects/Provenly/contracts/earn-quest/src/storage.rs) and [types.rs](file:///c:/Users/USER/Desktop/Projects/Provenly/contracts/earn-quest/src/types.rs).
- Off-chain state migration tools, such as the [migrate-contract-storage.mjs](file:///c:/Users/USER/Desktop/Projects/Provenly/scripts/deploy/migrate-contract-storage.mjs) utility.
...
All Provenly events must strictly follow the **Indexed Topic & Data Schema**:
...
4. **Document deprecation** in [EVENT_SPECIFICATION.md](file:///c:/Users/USER/Desktop/Projects/Provenly/contracts/earn-quest/docs/EVENT_SPECIFICATION.md) at least one release cycle before removal.
...
Provenly implements a gas-optimized **split-storage pattern** to manage resource fees:
...
Every Pull Request must successfully execute the following cargo tests in [test_migration.rs](file:///c:/Users/USER/Desktop/Projects/Provenly/contracts/earn-quest/tests/test_migration.rs):
...
- [ ] **Documentation Updated**: If new events or storage fields were added, [EVENT_SPECIFICATION.md](file:///c:/Users/USER/Desktop/Projects/Provenly/contracts/earn-quest/docs/EVENT_SPECIFICATION.md) and [MIGRATION_GUIDE.md](file:///c:/Users/USER/Desktop/Projects/Provenly/contracts/earn-quest/MIGRATION_GUIDE.md) have been updated to reflect the new schemas.
