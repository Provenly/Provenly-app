...
use earn_quest::{ProvenlyContractClient, Dispute, DisputeStatus};
...
fn setup(env: &Env) -> (ProvenlyContractClient, Address) {
    let cid = env.register_contract(None, earn_quest::ProvenlyContract);
