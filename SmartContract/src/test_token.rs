use crate::{ProvenlyContract, ProvenlyContractClient};
use soroban_sdk::testutils::Address as _;
use soroban_sdk::{Address, Env, String};

fn setup(env: &Env) -> (ProvenlyContractClient<'_>, Address) {
    env.mock_all_auths();
    let cid = env.register_contract(None, ProvenlyContract);
    let client = ProvenlyContractClient::new(env, &cid);
...
fn test_token_metadata() {
    ...
    assert_eq!(client.name(), String::from_str(&env, "Provenly Token"));
