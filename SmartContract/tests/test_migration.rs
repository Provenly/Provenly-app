...
fn setup_initialized_contract(env: &Env) -> (Address, ProvenlyContractClient<'_>, Address) {
...
fn test_quest_data_persists_across_simulated_upgrade() {
    ...
    let client_after_upgrade = ProvenlyContractClient::new(&env, &contract_id);
...
fn test_storage_schema_compatibility() {
    ...
    // Simulate upgrade
    let client_after = ProvenlyContractClient::new(&env, &contract_id);
...
fn test_migration_with_pending_submissions() {
    ...
    // Simulate upgrade
    let _client_after = ProvenlyContractClient::new(&env, &contract_id);
}
...
fn test_contract_state_recoverable() {
    ...
    let client_rollback = ProvenlyContractClient::new(&env, &contract_id);
