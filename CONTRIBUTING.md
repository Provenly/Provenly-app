...
Thank you for contributing to **Provenly**! This guide covers the standards every contributor must follow to keep the codebase consistent, secure, and maintainable.
...
Repository-maintained scripts are tracked in [docs/script-inventory.md](/Users/macbook/stellar/Provenly/docs/script-inventory.md:1). When you add or change a script, update that inventory with:
...
- Snapshot tests in `contracts/provenly/test_snapshots/` must be updated when behavior changes
...
- Changes to `contracts/provenly/src/**` must update [contracts/provenly/CHANGELOG.md](contracts/provenly/CHANGELOG.md)
...
- See [contracts/provenly/docs/CHANGELOG_DISCIPLINE.md](contracts/provenly/docs/CHANGELOG_DISCIPLINE.md) for the full policy and CI-enforced expectations
